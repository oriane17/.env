...
Object handle_buffer_get_line(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[1].type == kObjectTypeInteger) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 2, expecting Integer");
    goto cleanup;
  }
...
Object handle_nvim_buf_attach(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[1].type == kObjectTypeBoolean) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 2, expecting Boolean");
    goto cleanup;
  }
  ...
  if (args.items[2].type == kObjectTypeDictionary) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 3, expecting DictionaryOf(LuaRef)");
    goto cleanup;
  }
...
Object handle_buffer_set_line(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[2].type == kObjectTypeString) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 3, expecting String");
    goto cleanup;
  }
...
Object handle_buffer_get_line_slice(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[2].type == kObjectTypeInteger) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 3, expecting Integer");
    goto cleanup;
  }
  ...
  if (args.items[3].type == kObjectTypeBoolean) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 4, expecting Boolean");
    goto cleanup;
  }
  ...
  if (args.items[4].type == kObjectTypeBoolean) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 5, expecting Boolean");
    goto cleanup;
  }
...
Object handle_buffer_set_line_slice(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[5].type == kObjectTypeArray) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 6, expecting ArrayOf(String)");
    goto cleanup;
  }
...
Object handle_nvim_buf_set_lines(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[4].type == kObjectTypeArray) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 5, expecting ArrayOf(String)");
    goto cleanup;
  }
...
Object handle_nvim_buf_get_var(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[1].type == kObjectTypeString) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 2, expecting String");
    goto cleanup;
  }
...
Object handle_nvim_buf_set_keymap(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[3].type == kObjectTypeString) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 4, expecting String");
    goto cleanup;
  }
  ...
  if (args.items[4].type == kObjectTypeDictionary) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 5, expecting Dictionary");
    goto cleanup;
  }
...
Object handle_nvim_buf_get_commands(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[1].type == kObjectTypeDictionary) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 2, expecting Dictionary");
    goto cleanup;
  }
...
Object handle_buffer_insert(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[2].type == kObjectTypeArray) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 3, expecting ArrayOf(String)");
    goto cleanup;
  }
...
Object handle_nvim_buf_get_extmark_by_id(uint64_t channel_id, Array args, Error *error)
{
  ...
  ArrayOf(Integer) rv = nvim_buf_get_extmark_by_id(arg_1, arg_2, arg_3, error);
...
Object handle_nvim_buf_set_extmark(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[3].type == kObjectTypeInteger) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 4, expecting Integer");
    goto cleanup;
  }
  ...
  if (args.items[4].type == kObjectTypeInteger) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 5, expecting Integer");
    goto cleanup;
  }
  ...
  if (args.items[5].type == kObjectTypeDictionary) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 6, expecting Dictionary");
    goto cleanup;
  }

  Integer rv = nvim_buf_set_extmark(arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, error);
...
Object handle_nvim_buf_add_highlight(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[5].type == kObjectTypeInteger) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 6, expecting Integer");
    goto cleanup;
  }
...
Object handle_nvim_buf_set_virtual_text(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[3].type == kObjectTypeArray) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 4, expecting Array");
    goto cleanup;
  }
...
Object handle_nvim_buf_get_virtual_text(uint64_t channel_id, Array args, Error *error)
{
#if MIN_LOG_LEVEL <= DEBUG_LOG_LEVEL
  logmsg(DEBUG_LOG_LEVEL, "RPC: ", NULL, -1, true, "ch %" PRIu64 ": invoke nvim_buf_get_virtual_text", channel_id);
#endif
  Object ret = NIL;
  Buffer arg_1;
  Integer arg_2;
  ...
  Array rv = nvim_buf_get_virtual_text(arg_1, arg_2, error);
...
Object handle_nvim__buf_add_decoration(uint64_t channel_id, Array args, Error *error)
{
#if MIN_LOG_LEVEL <= DEBUG_LOG_LEVEL
  logmsg(DEBUG_LOG_LEVEL, "RPC: ", NULL, -1, true, "ch %" PRIu64 ": invoke nvim__buf_add_decoration", channel_id);
#endif
  Object ret = NIL;
  Buffer arg_1;
  Integer arg_2;
  ...
  if (args.size != 8) {
    api_set_error(error, kErrorTypeException, 
      "Wrong number of arguments: expecting 8 but got %zu", args.size);
    goto cleanup;
  }
  ...
  if (args.items[6].type == kObjectTypeInteger) {
    arg_7 = args.items[6].data.integer;
  } else {
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 7, expecting Integer");
    goto cleanup;
  }

  if (args.items[7].type == kObjectTypeArray) {
    arg_8 = args.items[7].data.array;
  } else {
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 8, expecting Array");
    goto cleanup;
  }

  Integer rv = nvim__buf_add_decoration(arg_1, arg_2, arg_3, arg_4, arg_5, arg_6, arg_7, arg_8, error);
...
Object handle_nvim_tabpage_list_wins(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[0].type == kObjectTypeTabpage && args.items[0].data.integer >= 0) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 1, expecting Tabpage");
    goto cleanup;
  }
...
Object handle_nvim_ui_attach(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[0].type == kObjectTypeInteger) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 1, expecting Integer");
    goto cleanup;
  }
  ...
  if (args.items[2].type == kObjectTypeDictionary) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 3, expecting Dictionary");
    goto cleanup;
  }
...
Object handle_ui_attach(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[2].type == kObjectTypeBoolean) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 3, expecting Boolean");
    goto cleanup;
  }
...
Object handle_nvim_ui_set_option(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[0].type == kObjectTypeString) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 1, expecting String");
    goto cleanup;
  }
...
Object handle_nvim_ui_pum_set_bounds(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[0].type == kObjectTypeFloat) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 1, expecting Float");
    goto cleanup;
  }
  ...
  if (args.items[1].type == kObjectTypeFloat) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 2, expecting Float");
    goto cleanup;
  }
  ...
  if (args.items[2].type == kObjectTypeFloat) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 3, expecting Float");
    goto cleanup;
  }
  ...
  if (args.items[3].type == kObjectTypeFloat) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 4, expecting Float");
    goto cleanup;
  }
...
Object handle_nvim_execute_lua(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[1].type == kObjectTypeArray) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 2, expecting Array");
    goto cleanup;
  }
...
Object handle_nvim_call_dict_function(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[2].type == kObjectTypeArray) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 3, expecting Array");
    goto cleanup;
  }
...
Object handle_nvim_get_runtime_file(uint64_t channel_id, Array args, Error *error)
{
  ...
  ArrayOf(String) rv = nvim_get_runtime_file(arg_1, arg_2);
...
Object handle_nvim_set_current_win(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[0].type == kObjectTypeWindow && args.items[0].data.integer >= 0) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 1, expecting Window");
    goto cleanup;
  }
...
Object handle_nvim_create_buf(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[0].type == kObjectTypeBoolean) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 1, expecting Boolean");
    goto cleanup;
  }
...
Object handle_nvim_put(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[0].type == kObjectTypeArray) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 1, expecting ArrayOf(String)");
    goto cleanup;
  }
...
Object handle_nvim_get_context(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[0].type == kObjectTypeDictionary) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 1, expecting Dictionary");
    goto cleanup;
  }
...
Object handle_nvim_set_keymap(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[3].type == kObjectTypeDictionary) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 4, expecting Dictionary");
    goto cleanup;
  }
...
Object handle_nvim_call_atomic(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[0].type == kObjectTypeArray) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 1, expecting Array");
    goto cleanup;
  }
...
Object handle_nvim_win_set_buf(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[1].type == kObjectTypeBuffer && args.items[1].data.integer >= 0) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 2, expecting Buffer");
    goto cleanup;
  }
...
Object handle_nvim_win_set_cursor(uint64_t channel_id, Array args, Error *error)
{
  ...
  if (args.items[1].type == kObjectTypeArray) {
    ...
    api_set_error(error, kErrorTypeException, 
          "Wrong type for argument 2, expecting ArrayOf(Integer, 2)");
    goto cleanup;
  }
...
void msgpack_rpc_init_method_table(void)
{
  ...
  msgpack_rpc_add_method_handler((String) {.data = "nvim_buf_get_virtual_text", .size = sizeof("nvim_buf_get_virtual_text") - 1}, (MsgpackRpcRequestHandler) {.fn = handle_nvim_buf_get_virtual_text, .fast = false});
  msgpack_rpc_add_method_handler((String) {.data = "nvim__buf_add_decoration", .size = sizeof("nvim__buf_add_decoration") - 1}, (MsgpackRpcRequestHandler) {.fn = handle_nvim__buf_add_decoration, .fast = false});
  ...
  msgpack_rpc_add_method_handler((String) {.data = "nvim_get_runtime_file", .size = sizeof("nvim_get_runtime_file") - 1}, (MsgpackRpcRequestHandler) {.fn = handle_nvim_get_runtime_file, .fast = false});
