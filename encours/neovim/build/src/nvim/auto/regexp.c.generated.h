...
static inline char_u *cstrchr(const char_u *const s, const int c) FUNC_ATTR_PURE FUNC_ATTR_WARN_UNUSED_RESULT FUNC_ATTR_NONNULL_ALL FUNC_ATTR_ALWAYS_INLINE;
...
static fptr_T do_Lower(int *d, int c);
static int fill_submatch_list(int argc FUNC_ATTR_UNUSED, typval_T *argv, int argskip, int argcount) FUNC_ATTR_NONNULL_ALL;
...
static int vim_regexec_string(regmatch_T *rmp, char_u *line, colnr_T col, _Bool nl);
#include "nvim/func_attr.h"
