# 1 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
...
# 7 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 2
...
# 9 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 2
...
# 10 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 2
# 22 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
static void add_user(garray_T *users, char *user, 
# 22 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
                                                 _Bool 
# 22 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
                                                      need_copy)
{
  char *user_copy = (user != 
# 24 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
                            ((void *)0) 
# 24 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
                                 && need_copy)
    ? xstrdup(user) : user;

  if (user_copy == 
# 27 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
                  ((void *)0) 
# 27 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
                       || *user_copy == '\000') {
    if (need_copy) {
      xfree(user);
    }
...
{
  if (users == 
# 40 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
              ((void *)0)
# 40 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
                  ) {
    return 0;
  }
...

  {
    ...
    setpwent();
    while ((pw = getpwent()) != 
# 50 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
                               ((void *)0)
# 50 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
                                   ) {
      add_user(users, pw->pw_name, 
# 51 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
                                  1
# 51 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
                                      );
    }
    endpwent();
  }
# 77 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
  {
    ...
    if (user_env != 
# 86 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
                   ((void *)0) 
# 86 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
                        && *user_env != '\000') {
      int i;
      ...
      if (i == users->ga_len) {
        ...
        if (pw != 
# 100 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
                 ((void *)0)
# 100 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
                     ) {
          add_user(users, pw->pw_name, 
# 101 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
                                      1
# 101 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
                                          );
        }
      }
    }
...
int os_get_uname(uv_uid_t uid, char *s, size_t len)
{
  ...
  if ((pw = getpwuid(uid)) != 
# 131 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
                             ((void *)0)
      
# 132 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
     && pw->pw_name != 
# 132 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
                       ((void *)0) 
# 132 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
                            && *(pw->pw_name) != '\000') {
...
char *os_get_user_directory(const char *name)
{
  ...
  if (name == 
# 147 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
             ((void *)0) 
# 147 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
                  || *name == '\000') {
    return 
# 148 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
          ((void *)0)
# 148 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
              ;
  }
  struct passwd *pw = getpwnam(name);
  if (pw != 
# 151 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
           ((void *)0)
# 151 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
               ) {
  ...
  return 
# 156 "/home/toto/.env/encours/neovim/src/nvim/os/users.c" 3 4
        ((void *)0)
# 156 "/home/toto/.env/encours/neovim/src/nvim/os/users.c"
            ;
}
