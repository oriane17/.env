...
static qfline_T *get_nth_valid_entry(qf_list_T *qfl, int errornr, qfline_T *qf_ptr, int *qf_index, int dir);
static qfline_T *get_nth_entry(qf_list_T *qfl, int errornr, qfline_T *qf_ptr, int *cur_qfidx);
...
static int qf_jump_edit_buffer(qf_info_T *qi, qfline_T *qf_ptr, int forceit, win_T *oldwin, int *opened_window, int *abort);
...
static buf_T *qf_find_buf(const qf_info_T *qi) FUNC_ATTR_PURE FUNC_ATTR_WARN_UNUSED_RESULT;
static void qf_update_win_titlevar(qf_info_T *qi);
static void qf_update_buffer(qf_info_T *qi, qfline_T *old_last);
static int qf_buf_add_line(buf_T *buf, linenr_T lnum, const qfline_T *qfp, char_u *dirname) FUNC_ATTR_NONNULL_ALL;
...
static qfline_T *qf_find_entry_on_next_line(int bnr, linenr_T lnum, qfline_T *qfp, int *errornr);
static qfline_T *qf_find_entry_on_prev_line(int bnr, linenr_T lnum, qfline_T *qfp, int *errornr);
static qfline_T *qf_find_closest_entry(qf_list_T *qfl, int bnr, linenr_T lnum, int dir, int *errornr);
static void qf_get_nth_below_entry(qfline_T *entry, int *errornr, linenr_T n);
static void qf_get_nth_above_entry(qfline_T *entry, int *errornr, linenr_T n);
static int qf_find_nth_adj_entry(qf_list_T *qfl, int bnr, linenr_T lnum, linenr_T n, int dir);
...
static _Bool vgr_match_buflines(qf_info_T *qi, char_u *fname, buf_T *buf, regmmatch_T *regmatch, long tomatch, int duplicate_name, int flags);
...
static void hgr_search_file(qf_info_T *qi, char_u *fname, regmatch_T *p_regmatch) FUNC_ATTR_NONNULL_ARG(1, 3);
static void hgr_search_files_in_dir(qf_info_T *qi, char_u *dirname, regmatch_T *p_regmatch, const char_u *lang) FUNC_ATTR_NONNULL_ARG(1, 2, 3);
static void hgr_search_in_rtp(qf_info_T *qi, regmatch_T *p_regmatch, const char_u *lang) FUNC_ATTR_NONNULL_ARG(1, 2);
#include "nvim/func_attr.h"
