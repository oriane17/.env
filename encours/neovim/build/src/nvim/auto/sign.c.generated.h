...
static void insert_sign(buf_T *buf, signlist_T *prev, signlist_T *next, int id, const char_u *group, int prio, linenr_T lnum, int typenr );
static void insert_sign_by_lnum_prio(buf_T *buf, signlist_T *prev, int id, const char_u *group, int prio, linenr_T lnum, int typenr );
