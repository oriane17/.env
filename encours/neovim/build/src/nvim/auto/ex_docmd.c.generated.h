...
static _Bool parse_one_cmd(char_u **cmdlinep, parse_state_T *const out, LineGetter fgetline, void *fgetline_cookie);
...
static int uc_add_command(char_u *name, size_t name_len, char_u *rep, uint32_t argt, long def, int flags, int compl, char_u *compl_arg, int addr_type, int force);
static char *get_command_complete(int arg);
static void uc_list(char_u *name, size_t name_len);
static int uc_scan_attr(char_u *attr, size_t len, uint32_t *argt, long *def, int *flags, int *complp, char_u **compl_arg, int *addr_type_arg);
