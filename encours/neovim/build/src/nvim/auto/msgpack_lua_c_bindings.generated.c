...
static int nlua_msgpack_nvim__buf_set_luahl(lua_State *lstate)
{
  Error err = ERROR_INIT;
  ...
  if (!nlua_is_deferred_safe(lstate)) {
    return luaL_error(lstate, e_luv_api_disabled, "nvim__buf_set_luahl");
  }
  ...
  nvim__buf_set_luahl(LUA_INTERNAL_CALL, arg1, arg2, &err);
...
static int nlua_msgpack_nvim_buf_get_extmark_by_id(lua_State *lstate)
{
  ...
  const ArrayOf(Integer) ret = nvim_buf_get_extmark_by_id(arg1, arg2, arg3, &err);
  nlua_push_Array(lstate, ret, true);
  api_free_array(ret);
...
static int nlua_msgpack_nvim_buf_set_extmark(lua_State *lstate)
{
  ...
  const Integer ret = nvim_buf_set_extmark(arg1, arg2, arg3, arg4, arg5, arg6, &err);
  nlua_push_Integer(lstate, ret, true);
  api_free_integer(ret);
...
static int nlua_msgpack_nvim_buf_get_virtual_text(lua_State *lstate)
{
  Error err = ERROR_INIT;
  if (lua_gettop(lstate) != 2) {
    api_set_error(&err, kErrorTypeValidation, "Expected 2 arguments");
  ...
  if (!nlua_is_deferred_safe(lstate)) {
    return luaL_error(lstate, e_luv_api_disabled, "nvim_buf_get_virtual_text");
  }
  const Integer arg2 = nlua_pop_Integer(lstate, &err);
  ...
  const Array ret = nvim_buf_get_virtual_text(arg1, arg2, &err);
  nlua_push_Array(lstate, ret, true);
  api_free_array(ret);
...
static int nlua_msgpack_nvim__buf_add_decoration(lua_State *lstate)
{
  Error err = ERROR_INIT;
  if (lua_gettop(lstate) != 8) {
    api_set_error(&err, kErrorTypeValidation, "Expected 8 arguments");
    goto exit_0;
  }
  if (!nlua_is_deferred_safe(lstate)) {
    return luaL_error(lstate, e_luv_api_disabled, "nvim__buf_add_decoration");
  }
  const Array arg8 = nlua_pop_Array(lstate, &err);

  if (ERROR_SET(&err)) {
    goto exit_0;
  }
  const Integer arg7 = nlua_pop_Integer(lstate, &err);
  ...
  const Integer ret = nvim__buf_add_decoration(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, &err);
  nlua_push_Integer(lstate, ret, true);
  api_free_integer(ret);
...
static int nlua_msgpack_nvim_get_runtime_file(lua_State *lstate)
{
  ...
  if (!nlua_is_deferred_safe(lstate)) {
    return luaL_error(lstate, e_luv_api_disabled, "nvim_get_runtime_file");
  }
  const Boolean arg2 = nlua_pop_Boolean(lstate, &err);
  ...
  const ArrayOf(String) ret = nvim_get_runtime_file(arg1, arg2);
  nlua_push_Array(lstate, ret, true);
  api_free_array(ret);
...
static int nlua_msgpack_nvim__put_attr(lua_State *lstate)
{
  Error err = ERROR_INIT;
  if (lua_gettop(lstate) != 5) {
    api_set_error(&err, kErrorTypeValidation, "Expected 5 arguments");
  ...
  if (!nlua_is_deferred_safe(lstate)) {
    return luaL_error(lstate, e_luv_api_disabled, "nvim__put_attr");
  }
  const Integer arg5 = nlua_pop_Integer(lstate, &err);
  ...
  nvim__put_attr(arg1, arg2, arg3, arg4, arg5);
  ...
  FUNC_ATTR_NONNULL_ALL
{
  ...
  lua_pushcfunction(lstate, &nlua_msgpack_nvim__buf_set_luahl);
  lua_setfield(lstate, -2, "nvim__buf_set_luahl");
  ...
  lua_pushcfunction(lstate, &nlua_msgpack_nvim_buf_get_virtual_text);
  lua_setfield(lstate, -2, "nvim_buf_get_virtual_text");
  lua_pushcfunction(lstate, &nlua_msgpack_nvim__buf_add_decoration);
  lua_setfield(lstate, -2, "nvim__buf_add_decoration");
  ...
  lua_pushcfunction(lstate, &nlua_msgpack_nvim__put_attr);
  lua_setfield(lstate, -2, "nvim__put_attr");
