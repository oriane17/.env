# 1 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
...
# 5 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 2
...
# 6 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 2
...
# 7 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 2
...
# 8 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 2
...
# 9 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 2
...
# 10 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 2
...
# 11 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 2
...
# 13 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 2
...
# 14 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 2
...
# 15 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 2
...
# 44 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
             ((void *)0)
# 44 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
             };

  for (int i = 0; i < SHAPE_IDX_COUNT; i++) {
    Dictionary dic = {.size = 0, .capacity = 0, .items = 
# 47 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
                    ((void *)0)
# 47 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
                    };
...
char_u *parse_shape_opt(int what)
{
  ...
  char_u *slashp;
  char_u *p = 
# 91 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
                  ((void *)0)
# 91 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
                      ;
  char_u *endp;
  int idx = 0;
  int all_idx;
  ...
  int i;
  int found_ve = 
# 97 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
                0
# 97 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
                     ;
  int round;
  ...
  for (round = 1; round <= 2; round++) {
    ...
    while (modep != 
# 107 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
                   ((void *)0) 
# 107 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
                        && *modep != '\000') {
      colonp = vim_strchr(modep, ':');
      commap = vim_strchr(modep, ',');

      if (colonp == 
# 111 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
                   ((void *)0) 
# 111 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
                        || (commap != 
# 111 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
                                      ((void *)0) 
# 111 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
        ...
        if (all_idx < 0) {
          ...
          if (len == 1 && (((modep[0]) < 'A' || (modep[0]) > 'Z') ? (modep[0]) : (modep[0]) + ('a' - 'A')) == 'a') {
            ...
            if (len == 2 && modep[0] == 'v' && modep[1] == 'e')
              found_ve = 
# 140 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
                        1
# 140 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
                            ;
          }
          modep += len + 1;
        }
...
# 179 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
                                       0
# 179 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
                                            , 0);
              if (len == 3) {
                if (n == 0) {
              ...
              endp = vim_strchr(p, '-');
              if (commap == 
# 206 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
                           ((void *)0)
# 206 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
                               ) {
                if (endp == 
# 207 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
                           ((void *)0)
# 207 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
                               )
                  endp = p + strlen((char *)(p));
              } else if (endp > commap || endp == 
# 209 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
                                                 ((void *)0)
# 209 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
                                                     ) {
                endp = commap;
              }
              slashp = vim_strchr(p, '/');
              if (slashp != 
# 213 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
                           ((void *)0) 
# 213 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
                                && slashp < endp) {
              ...
              if (round == 2) {
                ...
                if (slashp != 
# 222 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
                             ((void *)0) 
# 222 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
                                  && slashp < endp)
      ...
      modep = p;
      if (modep != 
# 234 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
                  ((void *)0) 
# 234 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
                       && *modep == ',') {
        modep++;
      }
    }
  ...
  ui_mode_info_set();
  return 
# 257 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
        ((void *)0)
# 257 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
            ;
}
...
# 264 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
_Bool 
# 264 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
...
int cursor_mode_str2int(const char *mode)
{
  ...
  logmsg(2, 
# 282 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
 ((void *)0)
# 282 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
 , __func__, 282, 
# 282 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
 1
# 282 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
...
# 287 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
_Bool 
# 287 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
    cursor_mode_uses_syn_id(int syn_id)
{
  if (*p_guicursor == '\000') {
    return 
# 290 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
          0
# 290 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
               ;
  }
  for (int mode_idx = 0; mode_idx < SHAPE_IDX_COUNT; mode_idx++) {
    if (shape_table[mode_idx].id == syn_id
      ...
      return 
# 295 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
            1
# 295 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
                ;
    }
  }
  return 
# 298 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c" 3 4
        0
# 298 "/home/toto/.env/encours/neovim/src/nvim/cursor_shape.c"
             ;
}
