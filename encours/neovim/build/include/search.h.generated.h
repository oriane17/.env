...
void find_pattern_in_path(char_u *ptr, int dir, size_t len, _Bool whole, _Bool skip_comments, int type, long count, int action, linenr_T start_lnum, linenr_T end_lnum );
